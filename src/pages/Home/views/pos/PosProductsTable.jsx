...
import AppSearchTextField from "../../../../components/inputs/AppSearchTextField.jsx"
...
function PosProductsTable() {
  ...
  }, [name, categoryId, rowsPerPage, page]) //eslint-disable-line react-hooks/exhaustive-deps
...
function PosProductsTableFooter({meta, currentPage, rowsPerPage, onChange, onPrevious, onNext}) {
  return (
